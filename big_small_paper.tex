...
the motion of a lineage is described by
\begin{align*}
    \E[g(L_{dt}) \given L_0 = y]
    &\approx
    g(y) + r(y) \gamma(y)
...
What about pollen?
Suppose the influx of pollen from $z$ into $x$ is $\rho(z) \delta(z) q_p(x - z)$,
and let $P$ be a random pollen displacement (i.e., $\P\{P = r\} = q_p(r)$).
Then as above we now have
\begin{align*}
    \E[g(L_{dt}) \given L_0 = y]
    &\approx
        g(y) 
        + \frac{1}{2} \frac{dt}{\rho(y)} \int \rho(x) \gamma(x) q(y - x) r(y) \left(g(x) - g(y)\right) dx \\
    &\qquad{}
        + \frac{1}{2} \frac{dt}{\rho(y)} \int \int \rho(z) \delta(z) q_p(x - z) \rho(x) \gamma(x) q(y - x) r(y) \left(g(z) - g(y)\right) dx \\
    &=
        g(y) 
        + \frac{1}{2} \frac{dt}{\rho(y)} \E\left[ \rho(y - R) \gamma(y - R) r(y) \left(g(y - R) - g(y)\right) \right]  \\
    &\qquad{}
        + \frac{1}{2} \frac{dt}{\rho(y)} \E\left[ \rho(y - R - P) \delta(y - R - P) \rho(y - R) \gamma(y - R) r(y) \left(g(y - R - P) - g(y)\right) \right] .
\end{align*}
Applying the above, first to $P$ and then to $R$, we get that
\begin{align*}
    &
    \E\left[ \rho(y - R - P) \delta(y - R - P) \rho(y - R) \gamma(y - R) r(y) \left(g(y - R - P) - g(y)\right) \right] \\
    &\approx \text{TODO THIS IS COMPLICATED}
\end{align*}
