...
\title{Gene flow in patchy environments}
...
\fancyhead[CO]{\MakeUppercase{\small{Gene flow in patchy environments}}}
...
$\begin{aligned} \label{eqn:basic_movement}
...
\begin{lemma}
    ...
    $\begin{aligned} \label{eqn:two_step}
        \var[L_2] 
            = \frac{4}{3} + 
            \frac{pq}{18(p+q)} \left\{
